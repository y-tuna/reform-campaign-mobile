# Full Package Spec v2

여기에 전체 기획/명세 문서를 넣으세요.
...
| 크레딧 | 표기용 회계: 후원/공천금 ↔ 사용내역 | 월말 정산, 환급 집행 |
...
- **푸시 알림**: Expo Notifications → OneSignal/Firebase 확장.  

### C. 웹
- Next.js → Vercel Preview/Prod.  
- 환경변수 `NEXT_PUBLIC_*`.  
...
### 4.1 권한 체계
- 후보자: 본인 계정, 사무관 공유 가능.  
- 중앙 관리자: 전체 뷰, 공지/정산 집행.  

### 4.2 운영 정책
- 앱: 오늘의 유세 중심, 증빙 업로드, 챗봇 Q&A.  
- 웹: 대시보드/문서 관리/후원 관리.  
...
## 5. 추가 보강 (시나리오 · 스케줄러 · 데이터 계약 등)

### 5.1 대표 사용자 시나리오 (앱 중심, 웹 연계)
